...
options = trainingOptions('adam', ...
    ...
    'LearnRateDropPeriod',300,... %Maybe back to 300 % Maybe back to 0.001
...
writetable(results_table, 'final_pred_val.csv');
...
writetable(results_table, 'final_pred_test.csv');
